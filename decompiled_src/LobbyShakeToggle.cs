...
public class LobbyShakeToggle : MonoBehaviour
{
	...
	public const string PREF_KEY = "MyMod_LobbyShakeEnabled";

	private const float ShakeAmount = 0.03f;

	private const float ShakePeriod = 400f;
	...
	private void TryBindFollowerCamera()
	{
		throw null;
	}
